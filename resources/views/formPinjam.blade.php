                            ...
                            <div class="lg:p-6 p-6 border-b-4 rounded-[5px] w-[720px] bg-white border-gray-300 shadow">
                                ...
                                <form action="/createpinjam" method="POST">
                                    ...
                                    <div class="mb-7">
                                        ...
                                        text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700
                                        dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500
                                        dark:focus:border-blue-500" placeholder="Nomor HP Mahasiswa" required>
                                    </div>

                                    {{-- <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-7"> --}}
                                        <div class="mb-7">
                                            <label for="dosen" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Dosen</label>
                                            <select name="dosen" id="dosen" value="{{ old('dosen') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500
                                        ...
                                        <div class="mb-7">
                                            <label for="alat" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Alat Pinjaman</label>
                                            <select name="alat" id="alat" value="{{ old('alat') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500
                                                focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white
                                                dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                                                @foreach ($alats as $alat)
                                                    <option type="" value="{{ $alat->id }}" class="">{{ $alat->nama }}</option>                                                    
                                                @endforeach 
                                            </select>                                            
                                        </div>
                                    {{-- </div> --}}
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-7">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <input type="time" id="time" name="waktu" class="bg-gray-50 border border-gray-300 text-gray-900
                                            text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700
                                            dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500
                                            dark:focus:border-blue-500" required>
                                        </div>
