                                ...
                                <tbody class="bg-white">
                                    <tr class="text-center">
                                        ...
                                        <td class="border border-r-0 border-l-0 border-t-0 border-slate-200 flex-row flex justify-center">
                                            <button type="button" class="text-white @if( $datas->status == 'Diterima') bg-sky-800 @elseif ($datas->status == "Ditolak")
                                                bg-red-600 @else bg-lime-800 @endif font-medium flex-row flex
