                                ...
                                <table class="table-fixed pt-4 divide-y divide-slate-900" id="dataTable">
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td class="border border-r-0 border-l-0 border-t-0 border-slate-200 px-2 py-2 text-sm text-center text-gray-500">
                                            <button class=" md:visible mdx:hidden md:mt-2 h-6 smx:text-xs smx:h-2 text-[10] mx-auto text-white bg-yellow-500 hover:bg-yellow-500 focus:ring-4 focus:outline-none font-medium rounded-[3px] text-sm px-4 text-center dark:bg-yellow-500 dark:hover:bg-yellow-500" type="button" data-modal-toggle="HDMI">
                                                aksi
                                            </button>
                                        </td>
