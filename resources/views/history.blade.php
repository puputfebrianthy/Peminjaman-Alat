                        ...
                        <div class="w-full flex">
                            <div class="lg:p-6 p-6 border-b-3 rounded-[5px] w-full">
								...
								<div class="flex justify-between  mb-4 mt-[0px]">
									<div></div>									
									<form class="flex items-center" action="/history" method="get">   
										@csrf
											...
											@foreach ($datas as $data)
												<tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
													...
													<td class="px-3 py-2 my-2 font-medium text-right  border-slate-200 relative flex-row flex justify-center">
														<div class="text-white bg-green-800 font-medium flex-row flex
                                                            items-center rounded-[2px] focus:outline-none mr-2">
                                                            <span href="#" class="px-2 py-1 text-sm rounded">
                                                                {{ $data->status }}
                                                            </span>
                                                        </div>
                                                	</td>
