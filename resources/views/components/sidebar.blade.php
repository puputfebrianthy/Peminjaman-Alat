            ...
            <ul class="flex flex-col ">
                ...
                <li>
                    <form action="{{ url('/logout') }}" method="post">
                        @method('post')
                        @csrf
                        <button type="submit" onclick=" return confirm('Anda yakin ingin keluar?')" class="flex items-center gap-x-4 h-[50px] rounded-xl px-4 hover:bg-white text-white hover:text-black" >
