                ...
                <div class="container flex flex-wrap justify-between items-center mx-auto">
                    ...
                    <div class="hidden w-full md:block md:w-auto" id="mobile-menu">
                        <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
                            <li>
                                <a href="#home"
                                    class="text-base nav-link block py-2 pr-4 pl-3 text-white hover:bg-white hover:text-black rounded-[5px]">Home</a>
                            </li>
                            <li>
                                <a href="#fasilitas"
                                    class="text-base nav-link block py-2 pr-4 pl-3 text-white hover:bg-white  hover:text-black rounded-[5px] ">Fasilitas</a>
                            </li>
                            <li>
                                <a href="#informasi"
                                    class="text-base nav-link block py-2 pr-4 pl-3 text-white  hover:bg-white  hover:text-black rounded-[5px] ">Informasi</a>
                            </li>
                            <li>
                                <a href="login"
                                    class="text-base nav-link block py-2 pr-4 pl-3 text-white hover:bg-white hover:text-black rounded-[5px]  ">Login</a>
                            </li>
