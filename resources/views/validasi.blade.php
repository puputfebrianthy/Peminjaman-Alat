                        ...
                        <div class="w-full flex">
                            <div class="lg:p-6 p-6 border-b-3 rounded-[5px] w-full">
								...
								<div class="flex justify-between  mb-4 mt-[0px]">
									<div></div>									
									<form class="flex items-center" action="/validasi" method="get">   
										@csrf
											...
											@foreach ($datas as $data)
												<tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
													...
													<td class="px-3 py-2 my-2 font-medium text-right  border-slate-200 relative flex-row flex justify-center">
														<a href="{{url("/validasi/diterima/{$data->id}")}}" onclick="return confirm('Yakin Untuk Menyetujui?')" class="text-white bg-blue-700 hover:bg-blue-800 flex-row flex
														items-center rounded-[3px] px-2 py-2 focus:outline-none mr-2">
														...
														<a href="{{url("/validasi/ditolak/{$data->id}")}}" onclick="return confirm('Yakin Untuk Menolak?')" class="text-white bg-red-700 hover:bg-red-800 font-medium flex-row flex
														items-center rounded-[3px] px-2 py-2 focus:outline-none mr-2 ">
